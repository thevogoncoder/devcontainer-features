...
```json
"features": {
    "ghcr.io/thevogoncoder/devcontainer-features/aws-cli-persistence:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/thevogoncoder/devcontainer-features/blob/main/src/aws-cli-persistence/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
